...
pub struct SerializerHandles<F>
where
    F: SerFlavor,
{
...
impl<'a, F> ser::Serializer for &'a mut SerializerHandles<F>
where
    F: SerFlavor,
{
    type Ok = ();
    ...
    fn serialize_struct(self, name: &'static str, len: usize) -> Result<Self::SerializeStruct> {
        if name == "Channel" {
            let _ = self.handles
                .try_extend(&(len as u64).to_le_bytes())
                .map_err(|_| Error::SerializeBufferFull)?;
            Ok(self)
        }
        else {
...
impl<'a, F> ser::SerializeSeq for &'a mut SerializerHandles<F>
where
    F: SerFlavor,
{
...
impl<'a, F> ser::SerializeTuple for &'a mut SerializerHandles<F>
where
    F: SerFlavor,
{
    type Ok = ();
...
impl<'a, F> ser::SerializeTupleStruct for &'a mut SerializerHandles<F>
where
    F: SerFlavor,
{
    type Ok = ();
...
impl<'a, F> ser::SerializeTupleVariant for &'a mut SerializerHandles<F>
where
    F: SerFlavor,
{
    type Ok = ();
...
impl<'a, F> ser::SerializeMap for &'a mut SerializerHandles<F>
where
    F: SerFlavor,
{
    type Ok = ();
...
impl<'a, F> ser::SerializeStruct for &'a mut SerializerHandles<F>
where
    F: SerFlavor,
{
    type Ok = ();
...
impl<'a, F> ser::SerializeStructVariant for &'a mut SerializerHandles<F>
where
    F: SerFlavor,
{
    type Ok = ();
